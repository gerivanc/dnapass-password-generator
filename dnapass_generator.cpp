 ...
 * Changelog: https://github.com/gerivanc/dnapass/blob/main/CHANGELOG.md
 * Issue Report: https://github.com/gerivanc/dnapass/blob/main/.github/ISSUE_TEMPLATE/issue_template.md
 * Version: 0.1.0
 */
...
int main() {
    try {
        ...
        PasswordResult result = generate_password(length, rng);
        ...
        std::cout << "GitHub: https://github.com/gerivanc\n";
        std::cout << "MIT License: https://github.com/gerivanc/dnapass/blob/main/LICENSE.md\n";
        std::cout << "\n"; // Blank line after
